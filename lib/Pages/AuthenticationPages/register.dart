...
class _RegisterState extends State<Register> {
  ...
  saveUserInfoToFirestore(User fUser) async {
    ...
    await WallShare.sharedPreferences.setString("uid", fUser.uid);
    await WallShare.sharedPreferences
        .setString(WallShare.userEmail, fUser.email);
    await WallShare.sharedPreferences
        .setString(WallShare.userName, _usernameController.text.trim());
    await WallShare.sharedPreferences
        .setString(WallShare.userAvatarUrl, userImageUrl);
  }
}
