...
class _ProfileState extends State<Profile> {
  ...
  final collectionReference = FirebaseFirestore.instance
      ...
      .where("user",
          isEqualTo: WallShare.sharedPreferences.getString(WallShare.userUID))
                ...
                userWallpapersList != null
                    ? Expanded(
                        child: Padding(
                          ...
                          child: userWallpapersList == 0
                              ? Container(
                                  width: double.infinity,
                                  height:
                                      MediaQuery.of(context).size.height - 219,
                                  child: new StaggeredGridView.countBuilder(
                                    crossAxisCount: 4,
                                    itemBuilder: (context, index) {
                                      String imgPath = userWallpapersList[index]
                                          .data()['url'];
                                      String tag = userWallpapersList[index]
                                          .data()['tag'];
                                      String category =
                              ...
                              : Center(
                                  child: Text(
                                  "You haven't added any wallpaper yet!",
                                  style: TextStyle(
                                    fontFamily: "Proxima Nova",
                                    fontWeight: FontWeight.w600,
                                    fontSize: 18,
